...
/**
 * Created by JoelHenning on 15-04-27.
 */
public class MyAdapter extends BaseAdapter {
    ...
    class ViewHolder {
        ...
        @InjectView(R.id.textView_year)
        TextView year;

        @InjectView(R.id.textView_slugline)
        TextView slugline;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.title.setText(mMovies.get(i).getTitle());

        String year = String.valueOf(mMovies.get(i).getYear());
        holder.year.setText(year);

        holder.slugline.setText(mMovies.get(i).getSlugline());
